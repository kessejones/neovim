...
local extension = {
  ...
  rul = function(path, bufnr)
    require('vim.filetype.detect').rul(bufnr)
  end,
  ...
  decl = function(path, bufnr)
    require('vim.filetype.detect').decl(bufnr)
  end,
  dec = function(path, bufnr)
    require('vim.filetype.detect').decl(bufnr)
  end,
  dcl = function(path, bufnr)
    require('vim.filetype.detect').dcl(bufnr)
  end,
  web = function(path, bufnr)
    require('vim.filetype.detect').web(bufnr)
  end,
  ...
  sgml = function(path, bufnr)
    require('vim.filetype.detect').sgml(bufnr)
  end,
